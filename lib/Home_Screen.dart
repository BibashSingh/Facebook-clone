  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            "facebook",
            style: const TextStyle(color: Colors.blue, fontSize: 29),
          ),
          actions: [
            CircleAvatar(
              backgroundColor: Color.fromARGB(54, 125, 123, 123),
              child: IconButton(
                  onPressed: (() {}),
                  icon: const Icon(
                    Icons.add,
              ...
              Row(
                children: [
                  ...
                  IconButton(
                      onPressed: (() {}),
                      icon: const Icon(
                        Icons.subscriptions,color: Colors.grey,
                        size: 40,
                      )),
                  const Spacer(),
                  IconButton(
...
////////////////////////////first bar end////////////////////////////////////////////////////                  //first bar icon end
                  const Spacer(),
                ],
              ),
              const Divider(
